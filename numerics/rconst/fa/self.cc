FeynAmpList[Model -> "SM", GenericModel -> "Lorentz", 
   ...
   ProcessName -> "S2S2", Process -> {{S[2], p1, MZ}} -> {{S[2], k1, MZ}}][
  FeynAmp[GraphName["S2S2", T1, I1], q1, 
   ...
   {Mass[F[Index[Generic, 3]]], Mass[F[Index[Generic, 4]]], 
    ...
    Insertions[Classes][{MLE[Index[Generation, 1]], 
      MLE[Index[Generation, 1]], -(EL*MLE[Index[Generation, 1]])/(2*MW*SW), 
  ...
  FeynAmp[GraphName["S2S2", T1, I2], q1, 
   (I/32*RelativeCF*FeynAmpDenominator[PropagatorDenominator[q1, 
      ...
      G[1][0][S[2], S[Index[Generic, 3]], S[Index[Generic, 4]]][1])/Pi^4, 
   {Mass[S[Index[Generic, 3]]], Mass[S[Index[Generic, 4]]], 
     G[1][0][S[2], -S[Index[Generic, 3]], -S[Index[Generic, 4]]][1], 
     G[1][0][S[2], S[Index[Generic, 3]], S[Index[Generic, 4]]][1], 
     RelativeCF} -> 
    Insertions[Classes][{MH, MZ, (-I/2*EL*MH^2)/(MW*SW), 
      (-I/2*EL*MH^2)/(MW*SW), 2}]], 
  FeynAmp[GraphName["S2S2", T1, I3], q1, 
   (-I/32*RelativeCF*FeynAmpDenominator[PropagatorDenominator[q1, 
        Mass[U[Index[Generic, 3]]]], 
       PropagatorDenominator[-k1 + q1, Mass[U[Index[Generic, 4]]]]]*
      G[1][0][S[2], -U[Index[Generic, 3]], -U[Index[Generic, 4]]][1]*
      G[1][0][S[2], U[Index[Generic, 3]], U[Index[Generic, 4]]][1])/Pi^4, 
   {Mass[U[Index[Generic, 3]]], Mass[U[Index[Generic, 4]]], 
     G[1][0][S[2], -U[Index[Generic, 3]], -U[Index[Generic, 4]]][1], 
     G[1][0][S[2], U[Index[Generic, 3]], U[Index[Generic, 4]]][1], 
     RelativeCF} -> 
    Insertions[Classes][{MW, MW, -(EL*MW)/(2*SW), -(EL*MW)/(2*SW), 2}, 
     {MW, MW, (EL*MW)/(2*SW), (EL*MW)/(2*SW), 2}]], 
  FeynAmp[GraphName["S2S2", T1, I4], q1, 
   (-I/16*RelativeCF*FeynAmpDenominator[PropagatorDenominator[q1, 
      ...
      MetricTensor[li1, li2]*G[-1][0][S[2], -S[Index[Generic, 3]], 
   ...
   {Mass[S[Index[Generic, 3]]], Mass[V[Index[Generic, 4]]], 
    ...
    Insertions[Classes][{MH, MZ, EL/(2*CW*SW), EL/(2*CW*SW), 1}, 
     {MW, MW, -EL/(2*SW), -EL/(2*SW), 1}, 
     {MW, MW, -EL/(2*SW), -EL/(2*SW), 1}]], 
  FeynAmp[GraphName["S2S2", T2, I1], q1, 
   (RelativeCF*FeynAmpDenominator[PropagatorDenominator[q1, 
        Mass[S[Index[Generic, 3]]]]]*
      G[1][0][S[2], S[2], -S[Index[Generic, 3]], S[Index[Generic, 3]]][1])/
