...
B1[p_, m1_, m2_] :=
  (m2 - m1) (B0[p, m1, m2] - B0[0, m1, m2])/(2 p) - B0[p, m1, m2]/2

(*
B1[p_, m1_, m2_] :=
  (A0[m1] - A0[m2] - (p + m2 - m1) B0[p, m1, m2])/(2 p)
*)
...
DB1[p_, m1_, m2_] = D[B1[p, m1, m2], p];
DB00[p_, m1_, m2_] = D[B00[p, m1, m2], p];
DB11[p_, m1_, m2_] = D[B11[p, m1, m2], p]
