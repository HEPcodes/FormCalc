...
diagrams.
\biitab
\Code{MultiplyDiagrams[\Var{amps},\,\Var{f}]} &
...
\indextt{TagDiagrams}%
\Code{MultiplyDiagrams[\Var{amp},\,\Var{f}]} multiplies the diagrams in
...
This provides a very simple mechanism to identify the origin of terms 
